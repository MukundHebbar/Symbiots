...
const Flame = () => {
  ...
  return (
    ...
    <div className="flex gap-3 mb-6">
        ...
        />
        <button 
              className="bg-red-400 hover:bg-red-500 px-5 py-3 rounded-lg font-semibold shadow-lg transition-all duration-300 hover:shadow-xl flex items-center justify-center gap-2 text-black"
